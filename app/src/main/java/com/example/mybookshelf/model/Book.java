...
public class Book {
    ...
    private Book(String title, String subTitle, String isbn, String description, String coverImageFilename) {
        this.mTitle = title;
    ...
    public static final Book[] books = {
            new Book(
                    ...
                    "",
                    "9786162045585",
                    "สอนเขียนแอพ Android โดยใช้ Android Studio ตั้งแต่การติดตั้งซอฟต์แวร์ต่างๆที่จำเป็น " +
                            "ไปจนถึงการส่งแอพเข้าสู่ Google Play อธิบายเนื้อหาอย่างเป็นลำดับขั้นตอน " +
                            "เพื่อให้คุณมีพื้นฐานที่แข็งแรงสำหรับการก้าวไปเป็นนักพัฒนามืออาชีพต่อไป",
                    "คู่มือเขียนแอพ_Android_ด้วย_Android_Studio.png"
            ),
            new Book(
                    "Head First Android Development",
                    "A Brain-Friendly Guide",
                    "9781449362188",
                    "If you have an idea for a killer Android app, " +
                            "this book will help you build your first working application in a jiffy. " +
                            "You’ll learn hands-on how to structure your app, design interfaces, " +
                            "create a database, make your app work on various smartphones " +
                            "and tablets, and much more. It’s like having an experienced " +
                            "Android developer sitting right next to you! All you need is some " +
                            "Java know-how to get started.",
                    "head_first_android_development.png"
            ),
            new Book(
                    "Code",
